...
export const Register = () => {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gray-100 px-4 bg-cover bg-center" style={{ backgroundImage: 'url("https://png.pngtree.com/background/20211215/original/pngtree-summer-lemon-ice-drink-blue-fresh-and-simple-summer-poster-background-picture-image_1481579.jpg")' }}>
